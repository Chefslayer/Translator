 ...
 */
void showFreqPhrases_subTrees_rek(Node *current, vector<unsigned int> &v_f, vector<unsigned int> v_e, const string &s_f, string s_e, Tree *phrasesF, Tree *phrasesE, Lexicon &e);
